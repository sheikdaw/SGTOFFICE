...
@section('content')
    ...
    <h3>Total Count : <span id="surveycount">{{ $pointCount }}<spam>
                ...
                <div id="map"></div>
                <div class="modal fade" id="buildingModal" tabindex="-1" aria-labelledby="buildingModalLabel"
                    aria-hidden="true">
                                ...
                                <form id="buildingForm" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="gisIdInput" name="gisid"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="building_usage" id="building_usage" class="form-control">
                                                ...
                                                <option value="OFFICE / LODGE / THEATER / RESTUARANTS">OFFICE / LODGE /
                                                    THEATER /
                                                    RESTUARANTS</option>
                ...
                <div class="modal fade" id="pointModal" tabindex="-1" aria-labelledby="pointModalLabel"
                    aria-hidden="true">
